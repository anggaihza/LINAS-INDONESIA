  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition absolute top-[35%] left-[50%] translate-x-[-50%] translate-y=[50%] duration-200 w-full  mx-auto flex items-center justify-center">
          {icon}
        </div>
